...
public class GUIManager : MonoBehaviour
{
    ...
    public Button bBathroom, bHospital, bStreet, bImagen, bDesplazamiento, bDuplicado, bElectrico, bIntruso, bParanormal;
    ...
    private void Start()
    {
        bBathroom.onClick.AddListener(delegate () { OnRoomButtonClicked(bBathroom,"Bathroom"); });
        bHospital.onClick.AddListener(delegate () { OnRoomButtonClicked(bHospital, "Hospital"); });
        bStreet.onClick.AddListener(delegate () { OnRoomButtonClicked(bStreet, "Street"); });
    ...
    private void ResetMenu()
    {
        ...
        selectedAnomaly = "";
        selectedRoom = "";
        bBathroom.interactable = true;
        bHospital.interactable = true;
        bStreet.interactable = true; 
    ...
    public void Report()
    {
        bBathroom.interactable = false;
        bHospital.interactable = false;
        bStreet.interactable = false;
